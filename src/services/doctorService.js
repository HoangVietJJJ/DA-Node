        ...
        try {
            ...
            if (checkObj.isValid === false) {
                ...
                if (extraInfor) {
                    ...
                    extraInfor.specialtyId = inputData.specialtyId;
                    extraInfor.clinicId = inputData.clinicId;
        ...
        try {
            if (!inputId) {
                ...
                if (dataDetail && dataDetail.image) {
                    dataDetail.image = new Buffer(dataDetail.image, 'base64').toString('binary');
                }
    ...
    return new Promise(async (resolve, reject) => {
        try {
            if (!doctorId || !date) {
                ...
                let dataT = await db.Schedule.findAll({
                    where: {
                        doctorId: doctorId,
                        date: date
                    },
